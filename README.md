...
**Performance Optimization** · Neural Network Inference · Clustering Algorithms · 
Linux Kernel Development · Character Device Drivers · IOCTL Protocol Design · 
TCP/IP Networking · Systems Programming · Process Management · Concurrency Patterns ·
Signal Handling · Memory Safety · C · Python
